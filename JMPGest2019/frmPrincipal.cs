...
namespace JMPGest2019
{
    public partial class frmPrincipal : Form
    {
        ...
        private void TablasButtonClick(object sender, EventArgs e)
        {
            ToolStripButton Opcion = (ToolStripButton)sender;
            int ButtonItem = 0;
            int.TryParse(Opcion.Tag.ToString(), out ButtonItem);
            frmTablas formTablas = new frmTablas();
            formTablas.MdiParent = this;
            formTablas.WindowState = FormWindowState.Maximized;
            formTablas.SelItem = ButtonItem;
            formTablas.Show();
        }
    }
